...
export function getFrequencySource(id: string) {
  switch (id) {
    ...
    case "396-hz-417-hz-639-hz":
      return require("../media/frequency/396-hz-417-hz-639-hz.mp3");
    case "417hz":
    ...
    default:
      throw new Error(`Frequency file not found: ${id}`);
  }
}
