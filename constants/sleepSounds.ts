...
export const sleepSounds: SleepSound[] = [
  ...
  },
  {
    ...
    icon: 'waves',
    color: '#3B82F6',
    audioUrl: 'https://www.soundjay.com/nature/sounds/ocean-waves-01.mp3',
  },
  {
    id: 'forest',
    ...
    icon: 'trees',
    color: '#10B981',
    audioUrl: 'https://www.soundjay.com/nature/sounds/forest-01.mp3',
  },
  {
    id: 'wind',
    title: 'Vent léger',
    ...
    icon: 'wind',
    color: '#8B5CF6',
    audioUrl: 'https://www.soundjay.com/nature/sounds/wind-blow-01.mp3',
  },
  {
    id: 'fire',
    title: 'Feu de camp',
    ...
    icon: 'flame',
    color: '#F59E0B',
    audioUrl: 'https://www.soundjay.com/nature/sounds/fire-burning-01.mp3',
  },
  {
    id: 'river',
    title: 'Rivière calme',
    ...
    icon: 'waves',
    color: '#06B6D4',
    audioUrl: 'https://www.soundjay.com/nature/sounds/water-stream-01.mp3',
  },
  {
    id: 'night',
    title: 'Nuit d été',
    ...
    icon: 'trees',
    color: '#0EA5E9',
    audioUrl: 'https://www.soundjay.com/nature/sounds/cricket-01.mp3',
  },
  {
    id: 'thunder',
